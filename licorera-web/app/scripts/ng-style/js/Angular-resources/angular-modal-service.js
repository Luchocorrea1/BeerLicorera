...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  var modele = angular.module('angularModalService', []);
	
	  modele.factory('ModalService', ['$animate', '$document', '$compile', '$controller', '$http', '$rootScope', '$q', '$templateRequest', '$timeout', function ($animate, $document, $compile, $controller, $http, $rootScope, $q, $templateRequest, $timeout) {
	    ...
	    function ModalService() {
	      ...
	      var getTemplate = function getTemplate(template, templateUrl) {
	        ...
	        if (template) {
	          ...
	          $templateRequest(templateUrl, true).then(function (templ) {
	            deferred.resolve(templ);
	          }, function (error) {
